/**
 * Kyla's while-you-wait tips — real menswear knowledge in her voice,
 * shown on the plan-building screen. Mirrors the strongest of her
 * server-side style gems so the wait teaches him something true.
 */
export const KYLA_TIPS: string[] = [
  ...
  "Never debut anything new on the big day. The proven outfit that's been to the tailor wins.",
  ...
  "When an outfit works, take the mirror photo. Six good photos is a personal lookbook.",
