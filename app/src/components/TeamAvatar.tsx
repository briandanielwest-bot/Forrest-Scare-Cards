...
export function TeamAvatar({ look, size }: { look: AvatarLook; size: number }) {
  ...
  return (
    ...
    >
      ...
      {look.hairStyle !== "buzz" ? (
        <View
          style={{
            position: abs,
            width: s(0.56),
            height: isLong ? s(0.24) : s(0.22),
            top: s(0.1),
            left: s(0.22),
            borderTopLeftRadius: s(0.28),
            borderTopRightRadius: s(0.28),
            borderBottomRightRadius: isLong ? s(0.14) : 0,
            backgroundColor: look.hair,
          }}
        />
      ) : (
      ...
      {/* brows */}
      <View style={{ position: abs, width: s(0.1), height: s(0.028), top: s(0.36), left: s(0.32), borderRadius: s(0.02), backgroundColor: look.hair }} />
      <View style={{ position: abs, width: s(0.1), height: s(0.028), top: s(0.36), left: s(0.58), borderRadius: s(0.02), backgroundColor: look.hair }} />

      {/* eyes */}
      <View style={{ position: abs, width: s(0.06), height: s(0.075), top: s(0.4), left: s(0.34), borderRadius: s(0.04), backgroundColor: look.eye }} />
      <View style={{ position: abs, width: s(0.06), height: s(0.075), top: s(0.4), left: s(0.6), borderRadius: s(0.04), backgroundColor: look.eye }} />
